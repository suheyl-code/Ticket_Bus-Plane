...
{
    internal class TurkishAirlines : Ulasim
    {

        public TurkishAirlines(Ulasim u)
        {
            Print.WriteLine("\tWelcome to Turkish Airlines Online System!", ConsoleColor.Blue);
            Print.WriteLine("TürkHavaYolları firmasının varış noktası < Ankara >, < Antalya >, < Adana > ve < Mersin >", ConsoleColor.Blue);
