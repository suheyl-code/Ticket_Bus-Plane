...
{
    internal class OnurAir : Ulasim
    {
        public OnurAir(Ulasim u)
        {
            Print.WriteLine("\tWelcome to OnurAir Online System!", ConsoleColor.Blue);
            Print.WriteLine("OnurAir firmasının varış noktası < Ankara >, < Antalya >, < Adana > ve < Mersin >", ConsoleColor.Blue);
