...
{
    internal class AnadoluJet : Ulasim
    {
        public AnadoluJet(Ulasim u)
        {
            Print.WriteLine("\tWelcome to AnadoluJet Online System!", ConsoleColor.Blue);
            Print.WriteLine("AnadoluJet firmasının varış noktası < Ankara >, < Antalya >, < Adana > ve < Mersin >", ConsoleColor.Blue);
